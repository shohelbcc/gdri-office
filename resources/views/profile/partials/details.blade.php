<form action="{{ route('admin.profile.details.update') }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('POST')
        ...
        <div class="card-body">
            <div class="form-group">
                @if ($user->profile->photo)
                    <img id="oldPhoto" src="{{ asset($user->profile->photo) }}" alt="User Photo" class="mb-3 d-block"
                ...
                <input name="photo" oninput="oldPhoto.src=window.URL.createObjectURL(this.files[0])" type="file"
                    class="form-control">
                @error('photo')
            ...
            <div class="form-group">
                ...
                <input type="text" id="designation" name="designation"
                    value="{{ old('designation', $user->profile->designation) }}" class="form-control" {{  (Auth::user()->hasRole('employee')) ? 'readonly' : '' }}>
                @error('designation')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="work_office" name="work_office"
                    value="{{ old('work_office', $user->profile->work_office) }}" class="form-control" required>
                @error('work_office')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="employee_status" name="employee_status"
                    value="{{ old('employee_status', $user->profile->employee_status) }}" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="links" name="links" value="{{ old('links', $user->profile->links) }}"
                    class="form-control">
                @error('links')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            ...
            <div class="form-group">
                ...
                <textarea id="biography" name="biography"
                    class="form-control">{{ old('biography', $user->profile->biography) }}</textarea>
                @error('biography')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
