...
@section('content')
    <section id="ongoingProjects" class="py-5 bg-gradient position-relative">
        <div class="container">
                ...
                @foreach ($ongoingProjects as $item)
                    <div class="col-12">
                        <a href="{{ route('project.details', $item['id']) }}" class="project-link w-100 text-decoration-none text-dark">
                            <div class="card ongoing-project-row-card border-0 shadow-lg rounded-4 w-100 h-100 mb-4 d-flex flex-row align-items-stretch flex-wrap flex-md-nowrap">
                                <div class="project-image-row d-flex align-items-center justify-content-center p-4 flex-shrink-0" style="min-width:160px;max-width:220px;">
