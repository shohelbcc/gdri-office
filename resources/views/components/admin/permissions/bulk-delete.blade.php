        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <div class="d-flex justify-content-end">
                    <button type="button" id="bulk_delete_modal_close" class="btn btn-sm btn-dark"
    ...
    <script>
        ...
        async function bulkDelete() {
            try {
                ...
                let res = await axios.post('/admin/permission/bulk-delete', { ids: idsArray }); // Fixed to use the correct variable
