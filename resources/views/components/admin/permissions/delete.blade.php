    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <button type="button" id="delete_modal_close" class="btn btn-sm btn-dark me-0"
                    data-bs-dismiss="modal">Cancel</button>
                <button onclick="itemDelete()" type="button" id="confirmDelete"
                    class="btn btn-sm btn-danger ms-0">Delete</button>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        async function itemDelete() {
            try {
                ...
                let res = await axios.post("/admin/permission/delete", { id: id })
