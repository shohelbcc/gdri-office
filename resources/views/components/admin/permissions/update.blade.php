    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">Update Permission</h6>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="nameUpdate" placeholder="Name" style="min-width: 300px !important">
...
<script>
    ...
    async function FillUpUpdateForm(id){
        try {
            ...
            $('#updateId').val(id);
            let res = await axios.post("/admin/permission/by-id",{id:id})
    ...
    async function Update() {
        try {
            ...
            let res = await axios.post('/admin/permission/update',formData)
