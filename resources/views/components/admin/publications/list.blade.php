                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-secondary text-white">Project Topic</th>
                                <th class="bg-secondary text-white">Authors</th>
                                <th class="bg-secondary text-white">Published Year</th>
                                <th class="bg-secondary text-white">Paper Type</th>
                                @can(['view-admin-publication', 'edit-admin-publication', 'delete-admin-publication'])
    ...
    <script>
        ...
        async function getList() {
            ...
            try {
                ...
                let res = await axios.get("/admin/publication/list");
                ...
                res.data.data.forEach(function (item, index) {
                    let row = `<tr>
                                    ...
                                    <td>${item.title}</td>
                                    <td>${item.publicationType?.name}</td>
                                    <td>${item.projectTopic?.name}</td>
                                    <td>${item.authors}</td>
