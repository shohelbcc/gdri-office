        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="card px-5 py-5">
                <div class="row justify-content-between pt-4">
                    ...
                    <div class="align-items-center col">
                        <span id="createbtn">
                            @can('create-admin-impact-stories')
                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                @can(['edit-admin-impact-stories', 'delete-admin-impact-stories'])
...
@push('scripts')
    <script>
        ...
        async function getList() {
            ...
            try {
                //    showLoader();
                let res = await axios.get("/admin/impact-stories/list");
                //    hideLoader();
                ...
                res.data.data.forEach(function (item, index) {
                    ...
                    let row = `<tr>
                                        ...
                                        @can(['edit-admin-impact-stories', 'delete-admin-impact-stories'])
                                                ...
                                                @endcan
                                                @can('delete-admin-impact-stories')
                                                    <button data-id="${item.id}" class="d-none d-xl-inline-block btn btn-sm deleteBtn btn-sm btn-outline-danger"><i class="fa fa-trash"></i></button>
                                                @endcan
                                            </td>
                                        @endcan
                                    </tr>`
