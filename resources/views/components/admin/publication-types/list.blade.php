            ...
            <div class="card px-5 py-5">
                <div class="row justify-content-between pt-4">
                    <div class="align-items-center col">
                        <h4>All Publication Types</h4>
                    </div>
                    <div class="align-items-center col">
                        <span id="createbtn">
                            @can('create-admin-publication-type')
                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                @can(['view-admin-publication-type', 'edit-admin-publication-type', 'delete-admin-publication-type'])
    ...
    <script>
        ...
        async function getList() {
            ...
            try {
                ...
                let res = await axios.get("/admin/publication/type/list");
