                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-secondary text-white">Website</th>
                                <th class="bg-secondary text-white">Logo</th>
                                @can(['view-admin-partner', 'edit-admin-partner', 'delete-admin-partner'])
    ...
    <script>
        ...
        async function getList() {
            ...
            try {
                ...
                let res = await axios.get("/admin/partners/list");
                ...
                res.data.data.forEach(function (item, index) {
                    let row = `<tr>
                                    ...
                                    <td>${item.name}</td>
                                    <td>${item.website ? `<a href="${item.website}" target="_blank">${item.website}</a>` : 'No Website'}</td>
                                    <td>${item.logo ? `<img src="${item.logo}" alt="Logo" style="width: 80px; height: auto;">` : 'No Logo'}</td>
                                    @can(['view-admin-partner', 'edit-admin-partner', 'delete-admin-partner'])
                                        <td class="action">
