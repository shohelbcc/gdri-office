                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr class="bg-light">
                                ...
                                <th class="bg-secondary text-white">Assign Permission(s)</th>
                                @can(['edit-roll', 'delete-role'])
...
@push('scripts')
    <script>
        ...
        async function getList() {
            ...
            try {
                //    showLoader();
                let res = await axios.get("/admin/role/list");
                //    hideLoader();
                ...
                res.data.data.forEach(function (item, index) {
                    let row = `<tr>
                                    ...
                                    <td>${item.name}</td>
                                    <td>
                                        <a href="role/assignPermission/${item.id}" class="btn btn-sm btn-info">Assign Permission(s)</a>
                                    </td>
