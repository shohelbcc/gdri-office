                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="Name" value="{{ old('name') }}" style="min-width: 300px !important">
    ...
    <script>
        ...
        async function Save() {
            try {
                ...
                let res = await axios.post('/admin/role/store', formData)
