    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">Update Topic</h6>
...
<script>
    ...
    async function FillUpUpdateForm(id){
        try {
            ...
            $('#updateId').val(id);
            let res = await axios.post("/admin/project/topic/by-id",{id:id})
    ...
    async function Update() {
        try {
            ...
            let res = await axios.post('/admin/project/topic/update', formData, {
