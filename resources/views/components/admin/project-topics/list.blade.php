            ...
            <div class="card px-5 py-5">
                <div class="row justify-content-between pt-4">
                    <div class="align-items-center col">
                        <h4>All Project Topics</h4>
                    </div>
                    <div class="align-items-center col">
                        <span id="createbtn">
                            @can('create-admin-project-topic')
                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                @can(['view-admin-project-topic', 'edit-admin-project-topic', 'delete-admin-project-topic'])
    ...
    <script>
        ...
        async function getList() {
            ...
            try {
                ...
                let res = await axios.get("/admin/project/topic/list");
