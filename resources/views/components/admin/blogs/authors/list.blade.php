                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                @can(['edit-admin-blog-author', 'delete-admin-blog-author'])
...
@push('scripts')
    <script>
        ...
        async function getList() {
            ...
            try {
                //    showLoader();
                let res = await axios.get("/admin/blog/author/list");
                //    hideLoader();
