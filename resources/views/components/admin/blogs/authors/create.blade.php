    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">Add New Author</h6>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="uemail" class="form-control" id="email" placeholder="Email" value="{{ old('email') }}">
    ...
    <script>
        ...
        async function Save() {
            try {
                ...
                let res = await axios.post('/admin/blog/author/store', formData)
