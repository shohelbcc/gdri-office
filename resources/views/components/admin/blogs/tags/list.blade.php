                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                @can(['edit-admin-blog-tag', 'delete-admin-blog-tag'])
...
@push('scripts')
    <script>
        ...
        async function getList() {
            ...
            try {
                //    showLoader();
                let res = await axios.get("/admin/blog/tag/list");
                //    hideLoader();
