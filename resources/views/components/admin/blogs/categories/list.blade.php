        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="card px-5 py-5">
                <div class="row justify-content-between pt-4">
                    ...
                    <div class="align-items-center col">
                        <span id="createbtn">
                            @can('create-admin-blog-category')
                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-secondary text-white">Slug</th>
                                @can(['edit-admin-blog-category', 'delete-admin-blog-category'])
...
@push('scripts')
    <script>
        ...
        async function getList() {
            ...
            try {
                //    showLoader();
                let res = await axios.get("/admin/blog/category/list");
                //    hideLoader();
