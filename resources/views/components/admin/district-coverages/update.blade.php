                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <label class="form-label">District Name <span class="text-danger ml-1">*</span></label>
                                <input type="text" class="form-control" id="nameUpdate" placeholder="District Name" value="{{ old('name') }}">
                                <select name="nameUpdate[]" id="nameUpdate" class="form-select" multiple>
...
<script>
    ...
    async function FillUpUpdateForm(id){
        try {
            ...
            $('#updateId').val(id);
            let res = await axios.post("/admin/district/coverage/by-id",{id:id})
    ...
    async function Update() {
        try {
            ...
            let res = await axios.post('/admin/district/coverage/update', formData);
