            ...
            <div class="card px-5 py-5">
                <div class="row justify-content-between pt-4">
                    <div class="align-items-center col">
                        <h4>All Coverage Districts</h4>
                    </div>
                    <div class="align-items-center col">
                        <span id="createbtn">
                            @can('create-admin-district-coverage')
                        ...
                        <thead>
                            <tr>
                                <th class="bg-secondary text-white" style="text-align: center; width: 10px !important;">
                                    #</th>
                                <th class="bg-secondary text-white">District Name</th>
                                @can(['view-admin-district-coverage', 'edit-admin-district-coverage', 'delete-admin-district-coverage'])
    ...
    <script>
        ...
        async function getList() {
            ...
            try {
                ...
                let res = await axios.get("/admin/district/coverage/list");
                                        ...
                                        @can(['view-admin-district-coverage', 'edit-admin-district-coverage', 'delete-admin-district-coverage'])
                                                ...
                                                <div class="dropdown d-xl-none">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        @can('delete-admin-district-coverage')
