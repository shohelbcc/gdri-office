            ...
            <div class="card px-5 py-5">
                <div class="row justify-content-between pt-4">
                    <div class="align-items-center col">
                        <h4>All Experience Certificates</h4>
                    </div>
                    <div class="align-items-center col">
                        <span id="createbtn">
                            @can('create-admin-experience-certificates')
                    ...
                    <table class="table table-striped" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-secondary text-white">Certificate Number</th>
                                <th class="bg-secondary text-white">PDF</th>
                                @can(['view-admin-experience-certificates', 'edit-admin-experience-certificates', 'delete-admin-experience-certificates'])
    ...
    <script>
        ...
        async function getList() {
            ...
            try {
                ...
                let res = await axios.get("/admin/experience-certificates/list");
                ...
                res.data.data.forEach(function (item, index) {
                    let row = `<tr>
                                    ...
                                    <td>${item.certificate ? `<a href="${item.certificate}" target="_blank">${item.certificate}</a>` : 'No certificate'}</td>
                                    @can(['view-admin-experience-certificates', 'edit-admin-experience-certificates', 'delete-admin-experience-certificates'])
                                        <td class="action">
